...
@RestController
@RequestMapping("/api/userauth-service-kafka")
public class UserauthServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UserauthServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UserauthServiceKafkaResource(KafkaProperties kafkaProperties) {
