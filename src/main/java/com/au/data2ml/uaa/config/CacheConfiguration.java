package com.au.data2ml.uaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("UserauthService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("UserauthService");
        ...
        config.getMapConfigs().put("com.au.data2ml.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
