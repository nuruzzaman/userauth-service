package com.au.data2ml.uaa.repository;

import com.au.data2ml.uaa.UserauthServiceApp;

import com.au.data2ml.uaa.config.Constants;
import com.au.data2ml.uaa.config.audit.AuditEventConverter;
import com.au.data2ml.uaa.domain.PersistentAuditEvent;
...
import static com.au.data2ml.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
