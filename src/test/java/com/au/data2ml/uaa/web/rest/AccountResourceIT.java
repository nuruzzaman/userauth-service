...
import com.au.data2ml.uaa.repository.AuthorityRepository;
...
import com.au.data2ml.uaa.service.dto.PasswordChangeDTO;
import com.au.data2ml.uaa.service.dto.UserDTO;
import com.au.data2ml.uaa.web.rest.vm.KeyAndPasswordVM;
...
import static com.au.data2ml.uaa.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@data2ml.com.au");
        ...
        restAccountMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.email").value("john.doe@data2ml.com.au"))
