package com.au.data2ml.uaa.config.timezone;

import com.au.data2ml.uaa.UserauthServiceApp;
import com.au.data2ml.uaa.repository.timezone.DateTimeWrapper;
import com.au.data2ml.uaa.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM data2ml_date_time_wrapper where id=%d", fieldName, id);
    }
